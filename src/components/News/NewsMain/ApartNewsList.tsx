  ...
  const dummyNews = [
    {
      ...
      newsDate: "2021.08.21",
      newsTitle:
        "‘LH부실공사’ 감리업체, 안전평가서도 문제점 수두룩 LH부실공사 감리업체, 안전평가서도 문제점 수두룩 LH부실공사’ 감리업체, 안전평가서도 문제점 수두룩",
      newsImg: "newsImg",
      newsDescription:
